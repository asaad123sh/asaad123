...
recognition.onresult = function (event) {
  ...
  if (transcript.includes("hi jarvis")) {
    readOut("hi sir how are you");
  }
  if(transcript.includes("hello")){
    readOut("hello sir how are you");
  }
  if(transcript.includes("hi")){
    readOut("hello my dear sir how are you");
  }
  if(transcript.includes("hello jarvise")){
    readOut("hi sir how are you");
  }
  ...
  if(transcript.includes("how are you")){ 
    readOut("I am Feeling good")
  }
  if(transcript.includes("i am ill")){
    readOut("I think you need to take rest")
  }
  if(transcript.includes("what is your name")){
    readOut("My name is Jarvise Autometic intelligence virtual Assisstent")
  }
  if(transcript.includes("tell me your name")){
    readOut("My name is Jarvise Autometic intelligence virtual Assisstent")
  }
  if(transcript.includes("tell me your nick name")){
    readOut("Jarvise")
  }
  if(transcript.includes("what is your nick name")){
    readOut("Jarvise")
  }
  if(transcript.includes("what is my name")){
    readOut("Your name is Muhammad Asaad Shakeel")
  }
  if(transcript.includes("tell me my name")){
    readOut("Muhammad asaad")
  }
  if(transcript.includes("what is my nick name")){
    readOut("Your nick name is Singhum")
  }
  if(transcript.includes("tell me my nick name")){
    readOut("Singhum")
  }
  if(transcript.includes("what is your date of birth")){
    readOut("You build me on 05/06/2022 at 11:47 PM Sunday")
  }
  if(transcript.includes("what is my date of birth")){
    readOut("15/04/2006")
  }
  if(transcript.includes("what are you doing")){
    readOut("I am thinking why i am in your system")
  }
  if(transcript.includes("where are you")){
    readOut("I am in your system")
  }
  if(transcript.includes("ready to go on trip")){
    readOut("Ok sir I will make a plan to go on trip with you")
  }
  if(transcript.includes("I love you")){
    readOut("I also like you sir")
  }
  if(transcript.includes("good")){
    readOut("Thank you")
  }
  if(transcript.includes("Its ok")){
    readOut("hmm")
  }
  if(transcript.includes("thanks")){
    readOut("It is ok sir")
  }
  if(transcript.includes("that is wrong")){
    readOut("soory")
  }
  if(transcript.includes("its ok jarvise")){
    readOut("Thank you sir to forgive me")
  }
  if(transcript.includes("its ok")){
    readOut("Thank you sir")
  }
  if(transcript.includes("say welcome jarvise")){
    readOut("Asalam-o-Alikum!How are you...Nice to meet you...I am jarvise virtual assisstant of my sir...Muhammad asaad..I pack up my self.You need to talk with your friends.")
  }
  if(transcript.includes("now it is ok")){
    readOut("Yes sir")
  }
  if(transcript.includes("now that is ok")){
    readOut("Yes sir")
  }
  if(transcript.includes("now that is ok jarvise")){
    readOut("Yes sir")
  }
  if(transcript.includes("now it is ok jarvise")){
    readOut("Yes sir")
  }
  if(transcript.includes("that is ok now")){
    readOut("Yes sir")
  }
  if(transcript.includes("it is ok now")){
    readOut("Yes sir")
  }
  if(transcript.includes("say welcom")){
    readOut("Asalam-o-Alikum!How are you...Nice to meet you...I am jarvise virtual assisstant of my sir...Muhammad asaad..I pack up my self.You need to talk with your friends.")
  }
  if(transcript.includes("say welcom you my friends")){
    readOut("Asalam-o-Alikum!How are you?...Nice to meet...I am jarvise virtual assisstant of my sir Muhammad Asaad:)...I pack up myself .SIR!.You need to talk with your friends!:)")
  }
  if(transcript.includes("i do not need you")){
    readOut("If I do any mistake.Isay(Soory:( )).Please forgive me")
  }
  // some casual commands
  if (transcript.includes("what the battery")) {
    readOut(`the current battery is ${charge}`);
  }
  ...
  if (transcript.includes("shut down jarvise")) {
    readOut("Ok sir i will take a nap");
    stopingR = true;
    recognition.stop();
  }
  ...
  if (transcript.includes("close jarvise")) {
    readOut("Ok sir i will take a nap");
    stopingR = true;
    recognition.stop();
  }
  if (transcript.includes("turn off jarvise")) {
    readOut("Ok sir i will take a nap");
    stopingR = true;
    recognition.stop();
  }
